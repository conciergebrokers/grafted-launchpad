...
-- Public inserts are allowed during the Stripe placeholder phase so the site can collect
-- identity details before a member finishes OAuth. Remove this when the paid checkout
-- flow is connected and all signups require auth before database write.
...
-- TODO: when Stripe is connected, use successful Stripe payment timestamps to set
-- founding_member = true for the first 15 paid signups.
